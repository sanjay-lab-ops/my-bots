...
start "BOT 1 - UTBot+VWAP" cmd /k "cd /d C:\Users\Sanjay_HivePro\Downloads\trading_automation && python main.py"
timeout /t 4 /nobreak >nul

echo  [2/3] Starting Bot 2 - Triple TF...
start "BOT 2 - Triple TF" cmd /k "cd /d C:\Users\Sanjay_HivePro\Downloads\VISHU_ELITE_BOT && python main.py"
timeout /t 4 /nobreak >nul

echo  [3/3] Starting Bot 3 - SMC 24/7...
start "BOT 3 - SMC 24/7" cmd /k "cd /d C:\Users\Sanjay_HivePro\Downloads\VISHU_SMC_BOT && python main.py"
